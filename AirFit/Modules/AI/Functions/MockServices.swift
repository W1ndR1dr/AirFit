...
// MARK: - Removed Mock Services
// NOTE: MockAINutritionService and MockEducationService have been removed
// as part of Phase 3 refactor. These functions are now handled by direct AI
// implementation in CoachEngine for improved performance and reduced token usage.
