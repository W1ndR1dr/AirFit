...
final class NutritionParsingFinalIntegrationTests: XCTestCase {
    ...
    func test_integration_completeUIFlow() async throws {
        ...
        // Step 1: Voice transcription received
        mockVoiceAdapter.simulateTranscription("grilled chicken with sweet potato")
        
        // Step 2: Automatic processing triggers
        // (Voice adapter callback should trigger processTranscription)
...
extension MockFoodVoiceAdapter {
