...
final class NutritionParsingExtensiveTests: XCTestCase {
    ...
    func test_nutritionParsing_commonFoods_accurateValues() async throws {
        let testCases: [(input: String, expectedCalories: ClosedRange<Int>, description: String)] = [
        ...
        for testCase in testCases {
            setupRealisticNutrition(for: testCase.input)
    ...
    func test_nutritionParsing_complexDescriptions_handlesCookingMethods() async throws {
        ...
        for (input, method) in cookingMethodTests {
            setupCookingMethodNutrition(for: input, method: method)
    ...
    func test_nutritionParsing_validation_rejectsUnrealisticValues() async throws {
        ...
        for invalidItem in invalidNutritionItems {
            coachEngine.mockParsedItems = [invalidItem]
            coachEngine.shouldThrowError = true // Use this to trigger validation fallback
    ...
    func test_nutritionParsing_validation_acceptsRealisticValues() async throws {
        ...
        for validItem in validNutritionItems {
            coachEngine.mockParsedItems = [validItem]
    ...
    func test_nutritionParsing_breakfastContext_adjustsCalories() async throws {
        // Given
        let input = "oatmeal"
        ...
        coachEngine.mockParsedItems = [expectedItem]
    ...
    private func setupRealisticNutrition(for food: String) {
        ...
        let coachEngine = self.coachEngine!
    ...
    private func setupMultipleItems(for description: String) {
    ...
    if words.contains("chicken") {
        items.append(ParsedFoodItem(name: "chicken", brand: nil, quantity: 4.0, unit: "oz",
    ...
    coachEngine.mockParsedItems = items.isEmpty ? [
        ParsedFoodItem(name: description, brand: nil, quantity: 1.0, unit: "serving",
                      calories: 200, proteinGrams: 10.0, carbGrams: 25.0, fatGrams: 5.0,
                      fiberGrams: 3.0, sugarGrams: 5.0, sodiumMilligrams: 200.0,
                      databaseId: nil, confidence: 0.80)
        ] : items
    }
    
    private func setupCookingMethodNutrition(for food: String, method: String) {
        ...
        coachEngine.mockParsedItems = [adjustedNutrition]
    }
    ...
    private func getRealisticNutrition(for food: String) -> ParsedFoodItem {
        ...
        case foodLower.contains("chicken"):
            return ParsedFoodItem(name: "chicken breast", brand: nil, quantity: 6.0, unit: "oz",
                                ...
                                fiberGrams: 0.0, sugarGrams: 0.0, sodiumMilligrams: 126.0,
                                databaseId: nil, confidence: 0.92)
        case foodLower.contains("broccoli"):
            return ParsedFoodItem(name: "broccoli", brand: nil, quantity: 1.0, unit: "cup",
                                calories: 31, proteinGrams: 2.6, carbGrams: 6.0, fatGrams: 0.3,
                                fiberGrams: 2.4, sugarGrams: 1.5, sodiumMilligrams: 30.0,
                                databaseId: nil, confidence: 0.90)
        case foodLower.contains("potato"):
            return ParsedFoodItem(name: "potato", brand: nil, quantity: 1.0, unit: "medium",
                                calories: 163, proteinGrams: 4.3, carbGrams: 37.0, fatGrams: 0.2,
                                fiberGrams: 4.7, sugarGrams: 2.0, sodiumMilligrams: 13.0,
                                databaseId: nil, confidence: 0.88)
        case foodLower.contains("spinach"):
            return ParsedFoodItem(name: "spinach", brand: nil, quantity: 1.0, unit: "cup",
                                calories: 7, proteinGrams: 0.9, carbGrams: 1.1, fatGrams: 0.1,
                                fiberGrams: 0.7, sugarGrams: 0.1, sodiumMilligrams: 24.0,
